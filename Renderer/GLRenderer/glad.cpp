/*
    ...
    OpenGL loader generated by glad 0.1.10a0 on Sat Mar 12 00:10:18 2016.
...
static int get_exts(void) {
    ...
    if(max_loaded_major < 3) {
        ...
        if (num_exts_i > 0) {
			const char** old_exts = exts_i;
			if ((exts_i = (const char **)realloc((void *)exts_i, num_exts_i * sizeof *exts_i)) == nullptr)
			{
				free(old_exts);
				exts_i = NULL;
			}
